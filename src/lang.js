...
const TEXT = {
  ...
  'wing.n2':            ['二番機', 'No.2'],
  'wing.n3':            ['三番機', 'No.3'],
  'brief.title':        ['アルカディア防衛戦', 'Defence of Arcadia'],
  'brief.enemy':        ['敵:企業連合 哨戒隊', 'Hostiles: corporate patrol'],
  'brief.friend':       ['味方:旧式艇 三機', 'Friendlies: three old boats'],
