...
const COLONY = {
  ...
  //   1800〜4600 のあいだで動く。見かけの大きさは40度〜57度 ―
  //   近づけば大きくなる。背景ではなく「そこにある場所」になる。
  //
  //   距離を決めている条件は1つだけ:輪の中へ飛び込まないこと。
  //   最接近1800 に対して輪の外縁は1170 なので、630 の余裕が残る。
  //   (以前は「遠い星の層(自機から1300)より外」という条件もあったが、
  //    星の深度テストを切って背景に戻したので、その縛りは消えた ―
  //    scene.js の createStarfield を参照)
  DIST: 3200,
  // 自機から見てどの方角に置くか。
  // ★ 背後 ― 正面から約125度 ― の左上に置く。
